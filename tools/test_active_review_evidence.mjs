...
try {
  ...
  await assert.rejects(() => loadVariant({ ...overrideValue, workbook_compatibility: { ...overrideValue.workbook_compatibility, trimmed_banner_cells: [unauthorizedA1Trim] } }), /trimmed_banner_cells\[0\]\.cell/);
